...
admin = Owner.create(username: 'admin',first_name: 'admin', last_name:'admin', password: 'password')

owner1 = Owner.create(username: 'fredflintstone',first_name: 'Wilma', last_name:'Flintstone', password: 'password')
owner12 = Owner.create(username: 'wilmaflintstone',first_name: 'Wilma', last_name:'Flintstone', password: 'password')
...
owner2 = Owner.create(username: 'georgejetson',first_name: 'George', last_name:'Jetson', password: 'password')
owner22 = Owner.create(username: 'janejetson',first_name: 'Jane', last_name:'Jetson', password: 'password')
...
owner3 = Owner.create(username: 'cliffordsowner',first_name: 'Clifford', last_name:'Owner', password: 'password')
owner32 = Owner.create(username: 'cliffordsowner2',first_name: 'Clifford', last_name:'Owner2', password: 'password')
